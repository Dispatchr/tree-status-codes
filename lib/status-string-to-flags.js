module.exports = {
  ...
  populateWithEnvironmental: function(environmental) {
    switch(environmental){
      case '1':
        this.statusFlags.environmental = 'riparian';
        break;
      case '2':
        this.statusFlags.environmental = 'velb';
        break;
      case '3':
        this.statusFlags.environmental = 'raptor_nest';
        break;
      case '4':
        this.statusFlags.environmental = 'other';
        break;
    }
    return this;
  }
